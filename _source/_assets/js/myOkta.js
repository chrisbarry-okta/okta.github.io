(function($) {    
  $(function() {
    ...
    var iframe = $('<iframe id="myOktaIFrame" src="https://login.okta.io:8080/discovery/iframe.html" style="display:none"></iframe>').get(0);

    $('body').append(iframe);

    $('#myOktaIFrame').load(function() {
      iframe.contentWindow.postMessage({messageType: 'get_accounts_json'}, 'https://login.okta.io:8080');
    });
